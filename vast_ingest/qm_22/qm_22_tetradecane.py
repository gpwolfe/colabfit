...
loader.config_table = "ndb.colabfit.dev.co_qm22_tetradec"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_tetradec"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_tetradec"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_tetradec"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/C14H30/n-C14H30.xyz"  # noqa: E501
)
DATASET_NAME = "QM-22_n-tetradecane_train"

DATASET_ID = "DS_gtkq8hnj6tdg_0"
LICENSE = "Apache-2.0"
...
DESCRIPTION = "The n-tetradecane training split of the QM-22 datasets. QM-22 consists of CHON molecules of 4-15 atoms, developed in counterpoint to the MD17 dataset, run at higher total energies (above 500 K) and with a broader configuration space."  # noqa: E501
