...
loader.config_table = "ndb.colabfit.dev.co_qm22_glycine"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_glycine"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_glycine"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_glycine"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/Glycine.xyz"
)
DATASET_NAME = "QM-22_Glycine"

DATASET_ID = "DS_72dnci6w4f0s_0"
LICENSE = "Apache-2.0"
PUBLICATION = "https://doi.org/10.1063/5.0037175"
...
DESCRIPTION = "The Glycine set of the QM-22 datasets. QM-22 consists of CHON molecules of 4-15 atoms, developed in counterpoint to the MD17 dataset, run at higher total energies (above 500 K) and with a broader configuration space."
...
property_map.set_metadata_field("basis-set", "aug-cc-pVDZ")
