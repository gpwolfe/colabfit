...
loader.config_table = "ndb.colabfit.dev.co_qm22_ethanol"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_ethanol"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_ethanol"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_ethanol"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/Ethanol.xyz"
)
DATASET_NAME = "QM-22_Ethanol"

DATASET_ID = "DS_y315cvty4fgf_0"
LICENSE = "Apache-2.0"
PUBLICATION = "https://doi.org/10.1063/5.0080506"
