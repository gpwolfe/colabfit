...
loader.config_table = "ndb.colabfit.dev.co_qm22_ochco"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_ochco"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_ochco"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_ochco"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/OCHCO_cation.xyz"  # noqa: E501
)
DATASET_NAME = "QM-22_OCHCO_cation"

DATASET_ID = "DS_lcy9bqjhga53_0"
LICENSE = "Apache-2.0"
PUBLICATION = "https://doi.org/10.1021/acs.jctc.8b00298"
...
DESCRIPTION = "The OCHCO cation set of the QM-22 datasets, with energies calculated at the CCSD(T) level of theory. QM-22 consists of CHON molecules of 4-15 atoms, developed in counterpoint to the MD17 dataset, run at higher total energies (above 500 K) and with a broader configuration space."  # noqa: E501
...
property_map.set_metadata_field("basis-set", "F12/aVTZ")
