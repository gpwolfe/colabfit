    ...
    dm.create_configuration_sets(
        ...
        name_label_match=[
            (
                ...
                f"{DATASET_NAME}",
                (
                    "Validation split of OC25: 203,630 single-point DFT calculations "
                    "of catalyst/solvent/ion/adsorbate solid-liquid interface structures, "
                    "representing OOD bulk-solvent combinations. Calculated with tighter "
                    "DFT convergence (EDIFF=1e-6 eV) than the training set."
                ),
                False,
            ),
        ],
