"""
Open_Direct_Air_Capture_ODAC2025_Train_Filtered ingest script for ColabFit VAST database.
...
File notes
----------
Source: odac25_filtered_train/train/ from https://huggingface.co/facebook/ODAC25
...
DATASET_ID = "DS_qx9u3v4xzt1f_0"
DATASET_NAME = "Open_Direct_Air_Capture_ODAC2025_Train_Filtered"
DESCRIPTION = (
    "This is the filtered training split of ODAC25. ODAC25 is a large-scale DFT dataset "
    "intended to advance the computational screening "
    "of Metal-Organic Framework (MOF) sorbents for direct air capture (DAC) of atmospheric "
    "CO2 from humid air. Spanning ~15,000 MOFs, including experimental, "
    "defective, synthetic, and amine-functionalized frameworks, the dataset comprises nearly "
    "60 million single-point calculations covering four adsorbates: CO2, H2O, N2, and O2. "
    "All calculations were performed with VASP 6.3 using the PBE functional augmented with "
    "D3 dispersion corrections (Becke-Johnson damping). Spin-polarized calculations (ISPIN=2) were "
    "used throughout. Relative to ODAC23, ODAC25 adds two new adsorbates (N2 and O2), "
    "functionalized MOF variants, improved k-point convergence, and re-relaxations of bare "
    "MOF cells. Three configuration sets are provided: mof_plus_adsorbate (full DFT relaxations of "
    "adsorbate-loaded MOFs), mof (re-relaxations of empty frameworks), and gcmc (DFT single "
    "points derived from Grand Canonical Monte Carlo simulations). "
    "Structures identified as problematic by Jin et al. (2025) have been excluded "
    "(see https://zenodo.org/records/14802658)."
)
...
LICENSE = "CC-BY-4.0"
DOI = None
DATA_PATH = Path("/scratch/gw2338/colabfit-tools/odac/odac25_filtered_train/train")
...
if __name__ == "__main__":
    ...
    loader.dataset_table = "ndb.colabfit.dev.ds_odac25_trn_filt"
    loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_odac25_trn_filt"
