"""
Open_Direct_Air_Capture_ODAC2025_Val_Full ingest script for ColabFit VAST database.
...
File notes
----------
Source: vast_ingest/odac_2025/odac25_full_val/val/
...
DATASET_ID = "DS_3hmdi49yv0er_0"
DATASET_NAME = "Open_Direct_Air_Capture_ODAC2025_Val_Full"
DESCRIPTION = (
    "The full (unfiltered) validation split of ODAC25. Open Direct Air Capture 2025 "
    "(ODAC25) is the largest high-quality DFT dataset "
...
LICENSE = "CC-BY-4.0"
DOI = None
DATA_PATH = Path("odac25_full_val/val")
...
if __name__ == "__main__":
    ...
    loader.config_table = "ndb.colabfit.dev.co_odac25_val_full"
    loader.config_set_table = "ndb.colabfit.dev.cs_odac25_val_full"
    loader.dataset_table = "ndb.colabfit.dev.ds_odac25_val_full"
    loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_odac25_val_full"
