...
# loader.config_table = "ndb.colabfit.dev.co_oodboth"
# loader.prop_object_table = "ndb.colabfit.dev.po_oodboth"
# loader.config_set_table = "ndb.colabfit.dev.cs_oodboth"
# loader.dataset_table = "ndb.colabfit.dev.ds_oodboth"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/data/s2ef_train_2M"
)
ELEMENTS = None
DATASET_NAME = "OC20_S2EF_train_2M"
DATASET_ID = "DS_7qi6dh0ig7sd_0"
LICENSE = "CC-BY-4.0"
DOI = None
...
DESCRIPTION = "OC20_S2EF_train_2M is the 2 million structure training subset of the OC20 Structure to Energy and Forces dataset. Features include potential energy, free energy and atomic forces. Data from the OC20 mappings file, including adsorbate id, materials project bulk id, miller index, shift and others."  # noqa
