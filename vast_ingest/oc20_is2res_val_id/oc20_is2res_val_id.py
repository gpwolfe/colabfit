...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/data/is2res_val_id_trajectories"  # noqa
)
DATASET_NAME = "OC20_IS2RES_val_id"
DATASET_ID = "DS_paumiiad6ttu_0"
DOI = None
...
DESCRIPTION = (
    "OC20_IS2RES_val_id is the in-domain validation set for the OC20 "
    "Initial Structure to Relaxed Structure (IS2RS) and Initial Structure to Relaxed "
    "Energy (IS2RE) tasks. Features include energy, "
