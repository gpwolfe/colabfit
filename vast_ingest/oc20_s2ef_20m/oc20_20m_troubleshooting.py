...
loader.config_table = "ndb.colabfit.dev.co_oc20_test3"
loader.config_set_table = "ndb.colabfit.dev.cs_oc20_test3"
loader.dataset_table = "ndb.colabfit.dev.ds_oc20_test3"
loader.prop_object_table = "ndb.colabfit.dev.po_oc20_test3"
...
# ):
#     print(file.name)
# co = list(oc_reader(file))
# if len(co) != 5000:
#     with open("missing_cos.txt", "a") as f:
#         f.write(file.name + "  " + len(co) + "\n")
beg = time()
# loader.zero_multiplicity(ds_id)
range = (1050, 1051)
config_generator = oc_wrapper(DATASET_FP, range)
# count = 0
# for x in config_generator:
#     count += 1
#     if count % 5000 == 0:
#         print(f"Count: {count}")
# print(f"Count: {count}")
