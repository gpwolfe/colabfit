...
D3.force-corrections          | (Nc, Na, 3) | Ha/Å
dipole     | (Nc, 3)                | eAngstrom

'D3.energy-corrections', 'D3.force-corrections', 'coordinates',
'dipole', 'energies', 'forces', 'species'
...
ELEMENTS = None
GLOB_STR = "ANI-2x-B973c-def2mTZVP.h5"
PI_METADATA = {
    "software": {"value": "ORCA 4.2.1"},
    "method": {"value": "DFT-B973c"},
    "basis_set": {"value": "def2m-TZVP"},
    "input": {
