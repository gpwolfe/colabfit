...
DATASET_NAME = "COMP6v2-wB97MV-def2TZVPP"
...
DATASET_DESC = (
    "COMP6v2-wB97MV-def2TZVPP is the portion of COMP6v2 calculated at the "
    "wB97MV/def2TZVPP level of theory. "
...
ELEMENTS = None
GLOB_STR = "COMP6v2-wB97MV-def2TZVPP.h5"
        ...
        for num_atoms in h5.keys():
            ...
            while True:
                for i, coord in enumerate(coordinates):
                    ...
                    config.info["name"] = (
                        f"COMP6v2-wB97MV-def2TZVPP__natoms_{num_atoms}__ix_{i}"
                    )
