...
Unzip file to project directory before running script.
unzip Metal-Oxide-Dataset-v1.0.zip -d <project_dir>
unzip "<project_dir>/saidigroup-Metal-Oxide-Dataset-2de736d/*.zip"
...
DATASET_FP = Path("data/saidigroup-Metal-Oxide-Dataset-2de736d/")
...
def reader(filepath: Path):
    ...
    for i, coord in enumerate(props["coord"]):
        ...
        atom.info["energy"] = int(props["energy"][i])
        atom.info["name"] = name
        atoms.append(atom)
    return atoms
