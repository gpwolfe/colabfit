...
DATASET_FP = Path(
    "data/stress-dependence_of_generalized_stacking_fault_energies-_a_dft_study/"
)
DATASET_NAME = "Al_Cu_Mg_GSFE_JMPS2019"
LICENSE = "https://creativecommons.org/licenses/by/4.0"

PUBLICATION = "https://doi.org/10.1016/j.jmps.2018.09.007"
DATA_LINK = "https://doi.org/10.24435/materialscloud:2019.0089/v1"
# OTHER_LINKS = []

AUTHORS = ["Binglun Yin", "Predrag Andric", "W. A. Curtin"]
DATASET_DESC = (
    'Dataset from "Stress-dependence of generalized stacking fault energies":'
    "DFT calculations of generalized stacking fault energies (GSFE) for Al, Cu, and Mg."
)
ELEMENTS = None
GLOB_STR = "OUTCAR"
...
CSS = [
    [
        f"{DATASET_NAME}_Al",
        {"names": {"$regex": "Al_gamma_line"}},
        f"Configurations of aluminum from {DATASET_NAME} dataset",
    ],
    [
        f"{DATASET_NAME}_Cu",
        {"names": {"$regex": "Cu_gamma_line"}},
        f"Configurations of copper from {DATASET_NAME} dataset",
    ],
    [
        f"{DATASET_NAME}_Mg",
        {"names": {"$regex": "Mg_gamma_line"}},
        f"Configurations of magnesium from {DATASET_NAME} dataset",
    ],
]
