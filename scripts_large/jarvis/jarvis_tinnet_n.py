...
DS_DESC = (
    ...
    "configurations from the TinNet-N dataset: a collection assembled to train a "
    ...
    "systems contained in this dataset consist of {100}-terminated Pt-based bimetallic "
    "surfaces doped with a third element. "
