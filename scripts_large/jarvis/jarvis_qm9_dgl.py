...
DS_DESC = (
    ...
    "configurations from the QM9 dataset, as hosted on the Deep Graph Library (DGL). "
    "Units for r2 (electronic spatial extent) are a\0^2; for alpha (isotropic "
    "polarizability), a\0^3; for mu (dipole moment), D; for Cv (heat capacity), "
