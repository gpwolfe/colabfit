...
DATASET_NAME = "COMP6v2-wB97X-631Gd"
...
DATASET_DESC = (
    "COMP6v2-wB97X-631Gd is the portion of COMP6v2 calculated at the "
    "wB97X/631Gd level of theory. "
...
ELEMENTS = None
GLOB_STR = "COMP6v2_wB97X-631Gd.h5"

PI_METADATA = {
    "software": {"value": "Gaussian 09"},
    "method": {"value": "DFT-wB97X"},
    "basis-set": {"value": "631Gd"},
    "input": {"value": " wb97x/6-31g* force Pop=hirshfeld"},
}
...
CO_METADATA = {
    "hirshfeld-atomic-dipoles": {"field": "hirshfeld_atomic_dipoles", "units": "a.u."},
    "hirshfeld-atomic-charges": {"field": "hirshfeld_atomic_charges", "units": "a.u."},
    "cm5-atomic-charges": {"field": "cm5_atomic_charges", "units": "a.u."},
}
...
def ani_reader(fp):
    with h5py.File(fp) as h5:
        for num_atoms in h5.keys():
            ...
            hirshfeld_atomic_charges = properties["hirshfeld_atomic_charges"]
            hirshfeld_atomic_dipoles = properties["hirshfeld_atomic_dipoles"]
            # scf_en = properties["wB97M_def2-TZVPP.scf-energies"]
            species = properties["species"]
            energies = properties["energies"]
            cm5_atomic_charges = properties["cm5_atomic_charges"]
            ...
            while True:
                for i, coord in enumerate(coordinates):
                    ...
                    config.info["hirshfeld_atomic_charges"] = hirshfeld_atomic_charges[
                        i
                    ]
                    # config.info["scf_energy"] = scf_en[i]
                    config.info["cm5_atomic_charges"] = cm5_atomic_charges[i]
                    config.info["forces"] = forces[i]
                    config.info["hirshfeld_atomic_dipoles"] = hirshfeld_atomic_dipoles[
                        i
                    ]
