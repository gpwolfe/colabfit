...
DATASET_DESC = (
    "The Matbench_perovskites dataset is a Matbench v0.1 test dataset for predicting "
    "formation energy from crystal structure. Adapted from an original dataset "
    "generated by Castelli et al. Refer to the Automatminer/Matbench publication for "
    "more details. This dataset contains the energy of formation of the entire 5-atom "
    "perovskite cell in eV as calculated by RPBE GGA-DFT. Note the reference state "
    "for oxygen was computed from oxygen's chemical potential in water vapor, not as "
    "oxygen molecules, to reflect the application for which these perovskites were "
    "studied. Matbench is an automated leaderboard for benchmarking state of the art "
...
ELEMENTS = None
GLOB_STR = "matbench_perovskites_structures.json"
...
def reader(fp):
    with open(fp, "r") as f:
        for i, line in tqdm(enumerate(f)):
            ...
            config.info["name"] = f"matbench_perovskites_{i}"
