...
DATASET_FP = Path("data/CGM-MLP-main/testing_screening_parameters")
...
DATASET_DESC = (
    "This dataset was one of the datasets used in testing screening parameters during "
    "the process of producing an active learning dataset for Cu-C "
    "interactions for the purposes of exploring substrate-catalyzed deposition as "
...
DSS = (
    (
        DATASET_NAME + "_graphite_train",
        "40 graphite structures with different lattice constants ranging from "
        f"2.0 to 3.2 Å, with a 0.03 Å increment. {DATASET_DESC}",
        "Graphite_Training_Set.xyz",
    ),
    # (
    #     DATASET_NAME + "_graphite_test",
    #     "20 randomly generated graphite crystal structures with lattice constants "
    #     f"ranging from 2.0 to 3.2 Å. {DATASET_DESC}",
    #     "Graphite_Testing_Set.xyz",
    # ),
    (
