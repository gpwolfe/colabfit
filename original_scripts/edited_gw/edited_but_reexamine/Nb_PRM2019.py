...
DS_DESC = (
    ...
    "of Nb elastic, thermal, and defect properties, as well as surface "
...
def main(argv):
    ...
    cs_regexes = {
        ...
        "short_range": "BCC crystals with random interstitial atom defects to "
        "capture short-range many-body dynamics",
