...
DATASET_NAME = "SAIT_semiconductors_ACS_2023_HfO"
...
DATASET_DESC = (
    "This dataset contains HfO configurations from the SAIT semiconductors "
...
CSS = [
    [
        f"{DATASET_NAME}_raw_crystal",
        {"names": {"$regex": "HfO_raw__Crystal"}},
        "Configurations of HfO crystal structures from the raw data for the "
        f"{DATASET_NAME} dataset.",
    ],
    [
        f"{DATASET_NAME}_raw_OOD",
        {"names": {"$regex": "HfO_raw__OOD"}},
        "Configurations of HfO out-of-domain structures from the raw data for the "
        f"{DATASET_NAME} dataset.",
    ],
    [
        f"{DATASET_NAME}_raw_random",
        {"names": {"$regex": "HfO_raw__Random"}},
        "Configurations of random HfO structures from the raw data for the "
        f"{DATASET_NAME} dataset, generated by randomly distributing 32 Hf and "
        "64 O atoms within the unit cells of the HfO2 crystals) configuration "
        "sets.",
    ],
]
...
DSS = (
    ...
    (
        ...
        # {"name": {"$regex": "_raw"}},
        "*.xyz",
        f"Structures from the {DATASET_NAME} dataset, separated into crystal, "
        "out-of-domain, and random (generated by randomly distributing 32 Hf and "
        "64 O atoms within the unit cells of the HfO2 crystals) configuration "
        "sets. " + DATASET_DESC,
    ),
)
...
def reader(fp: Path):
    ...
    name = "__".join(fp.parts[-4:]).replace("data__", "").replace(".xyz", "")
