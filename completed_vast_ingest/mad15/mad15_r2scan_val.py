"""
MAD-1.5_r2SCAN_Val ingest script for ColabFit VAST database.
...
File notes
----------
Source: mad15/mad-1.5-r2scan-val.xyz
...
smearing of 0.05 eV. The validation split (~10%) uses a stratified split
consistent with the training and test splits.
...
loader.config_table = "ndb.colabfit.dev.co_mad15_r2sc_val"
loader.config_set_table = "ndb.colabfit.dev.cs_mad15_r2sc_val"
loader.dataset_table = "ndb.colabfit.dev.ds_mad15_r2sc_val"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_mad15_r2sc_val"

DATASET_ID = "DS_lzf5dc7nytxe_0"
DATASET_NAME = "Massive_Atomic_Diversity_MAD-1.5_r2SCAN_Val"
DESCRIPTION = (
    "Validation split of the MAD-1.5 (Massive Atomic Diversity version 1.5) dataset, "
    ...
    "uncertainty-based filtering. The validation split (~10% of cleaned data) uses a "
    "stratified split method consistent with the training and test splits. A companion "
    "PBE-functional dataset (Massive_Atomic_Diversity_MAD-1.5_PBE) was used during model training with separate "
    "prediction heads."
)
...
DATA_PATH = Path(__file__).parent / "mad-1.5-r2scan-val.xyz"

SUBSET_DESCRIPTIONS = {
    "mc3d": (
        "Bulk crystals from the Materials Cloud 3D (MC3D) database, "
        "part of the MAD-1.5_r2SCAN_Val dataset."
    ),
    "mc3d_rattled": (
    ...
    "mc3d_random": (
        ...
        "structures, part of the MAD-1.5_r2SCAN_Val dataset."
    ),
    "mc3d_surface": (
    ...
    "trimers": (
        ...
        "102 elements, part of the MAD-1.5_r2SCAN_Val dataset."
    ),
    "mc3d_ext": (
        "Extended MC3D crystals covering 93 elements with Z<100, including "
        "lanthanides and actinides, part of the MAD-1.5_r2SCAN_Val dataset."
    ),
    "mc3d_random_ext": (
