...
loader.config_table = "ndb.colabfit.dev.co_vqm_uniques"
loader.config_set_table = "ndb.colabfit.dev.cs_vqm_uniques"
loader.dataset_table = "ndb.colabfit.dev.ds_vqm_uniques"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_vqm_uniques"

DATASET_ID = "DS_omu9mmep33g6_0"
DATASET_NAME = "Vector-QM24_DFT_uniques"
DESCRIPTION = "Structures from Vector-QM24 (VQM24) that represent constitutional isomers, or the most stable conformers, with properties calculated using DFT. Vector-QM24 is a quantum chemistry dataset of ~836 thousand small organic and inorganic molecules. Dataset covers all possible neutral closed-shell small organic and inorganic molecules with up to five heavy (p-block) atoms: C, N, O, F, Si, P, S, Cl, Br."  # noqa: E501
