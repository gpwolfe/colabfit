...
loader.config_table = "ndb.colabfit.dev.co_vqm_dmc"
loader.config_set_table = "ndb.colabfit.dev.cs_vqm_dmc"
loader.dataset_table = "ndb.colabfit.dev.ds_vqm_dmc"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_vqm_dmc"

DATASET_ID = "DS_dbso1owsqbwv_0"
DATASET_NAME = "Vector-QM24_DMC"
DESCRIPTION = "Lowest-energy structures with up to 4 heavy atoms from Vector-QM24 (VQM24) with properties calculated using diffusion quantum Monte Carlo (DMC) after DFT optimization. Vector-QM24 is a quantum chemistry dataset of ~836 thousand small organic and inorganic molecules. Dataset covers all possible neutral closed-shell small organic and inorganic molecules with up to five heavy (p-block) atoms: C, N, O, F, Si, P, S, Cl, Br."  # noqa: E501
...
property_map_dft.set_metadata_field("software", "QMCPACK")
property_map_dft.set_metadata_field("method", "DMC-PBE0-ccECP")
