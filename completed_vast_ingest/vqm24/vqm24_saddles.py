...
loader.config_table = "ndb.colabfit.dev.co_vqm_saddle"
loader.config_set_table = "ndb.colabfit.dev.cs_vqm_saddle"
loader.dataset_table = "ndb.colabfit.dev.ds_vqm_saddle"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_vqm_saddle"

DATASET_ID = "DS_fqtku6xqc1an_0"
DATASET_NAME = "Vector-QM24_DFT_saddles"
DESCRIPTION = "Structures from Vector-QM24 (VQM24) that converged to saddle points during relaxation, with properties calculated using DFT. Vector-QM24 is a quantum chemistry dataset of ~836 thousand small organic and inorganic molecules. Dataset covers all possible neutral closed-shell small organic and inorganic molecules with up to five heavy (p-block) atoms: C, N, O, F, Si, P, S, Cl, Br."  # noqa: E501
