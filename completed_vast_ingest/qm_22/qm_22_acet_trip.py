...
loader.config_table = "ndb.colabfit.dev.co_qm22_acet_t"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_acet_t"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_acet_t"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_acet_t"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/Acetaldehyde_triplet.xyz"  # noqa: E501
)
DATASET_NAME = "QM-22_Acetaldehyde_triplet"

DATASET_ID = "DS_0baqiwozmy40_0"
LICENSE = "Apache-2.0"
...
DESCRIPTION = "The Acetaldehyde (triplet) set of the QM-22 datasets, with energies calculated at the CCSD(T) level of theory. QM-22 consists of CHON molecules of 4-15 atoms, developed in counterpoint to the MD17 dataset, run at higher total energies (above 500 K) and with a broader configuration space."  # noqa: E501
