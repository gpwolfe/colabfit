...
loader.config_table = "ndb.colabfit.dev.co_qm22_h2co"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_h2co"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_h2co"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_h2co"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/H2CO_and_HCOH.xyz"  # noqa: E501
)
DATASET_NAME = "QM-22_H2CO_to_cis_and_trans_HCOH"

DATASET_ID = "DS_pci59t5zafkx_0"
LICENSE = "Apache-2.0"
...
property_map.set_metadata_field("method", "MRCI")
property_map.set_metadata_field("basis-set", "cc-pVTZ")
