...
loader.config_table = "ndb.colabfit.dev.co_qm22_methyl"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_methyl"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_methyl"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_methyl"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/N-methylacetamide.xyz"
)
DATASET_NAME = "QM-22_N-methyl_acetamide"

DATASET_ID = "DS_24d0nebgteu4_0"
LICENSE = "Apache-2.0"
PUBLICATION = "https://doi.org/10.1063/1.5119348"
...
DESCRIPTION = "The N-methyl acetamide set of the QM-22 datasets. QM-22 consists of CHON molecules of 4-15 atoms, developed in counterpoint to the MD17 dataset, run at higher total energies (above 500 K) and with a broader configuration space."
