...
loader.config_table = "ndb.colabfit.dev.co_qm22_ch3choo"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_ch3choo"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_ch3choo"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_ch3choo"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/syn-CH3CHOO.xyz"  # noqa: E501
)
DATASET_NAME = "QM-22_n-syn-CH3CHOO"

DATASET_ID = "DS_gn4qyaj4yn1x_0"
LICENSE = "Apache-2.0"
PUBLICATION = "https://doi.org/10.1038/nchem.2488"
...
DESCRIPTION = "The n-syn-CH3CHOO set of the QM-22 datasets, with energies calculated at the CCSD(T)/MRCI level of theory. QM-22 consists of CHON molecules of 4-15 atoms, developed in counterpoint to the MD17 dataset, run at higher total energies (above 500 K) and with a broader configuration space."  # noqa: E501

property_map = PropertyMap([energy_pd])
property_map.set_metadata_field("software", "MOLPRO/MOLCAS")
property_map.set_metadata_field("method", "CCSD(T)/MRCI")
property_map.set_metadata_field("basis-set", "aug-cc-pVDZ/cc-pVDZ(hydrogen)")
