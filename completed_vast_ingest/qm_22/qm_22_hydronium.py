...
loader.config_table = "ndb.colabfit.dev.co_qm22_hydronium"
loader.prop_object_table = "ndb.colabfit.dev.po_qm22_hydronium"
loader.config_set_table = "ndb.colabfit.dev.cs_qm22_hydronium"
loader.dataset_table = "ndb.colabfit.dev.ds_qm22_hydronium"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/qm22/Hydronium.xyz"  # noqa: E501
)
DATASET_NAME = "QM-22_Hydronium"

DATASET_ID = "DS_0sa5e1klrpzx_0"
LICENSE = "Apache-2.0"
...
DESCRIPTION = "The Hydronium set of the QM-22 datasets, with energies calculated at the CCSD(T)/MRCI level of theory. QM-22 consists of CHON molecules of 4-15 atoms, developed in counterpoint to the MD17 dataset, run at higher total energies (above 500 K) and with a broader configuration space."  # noqa: E501
...
property_map.set_metadata_field(
    "basis-set", "F12/aug-cc-pVQZ(CCSD(T))/aug-cc-pVTZ(MRCI)"
)
