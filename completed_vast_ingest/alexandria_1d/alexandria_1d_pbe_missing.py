...
missing = [
    "alexandria_1d_alex_go_aaa_001_4.pkl",
    "alexandria_1d_alex_go_aaa_001_5.pkl",
    "alexandria_1d_alex_go_aaa_001_6.pkl",
    "alexandria_1d_alex_go_aaa_001_7.pkl",
    "alexandria_1d_alex_go_aaa_001_8.pkl",
    "alexandria_1d_alex_go_aaa_001_9.pkl",
]
...
def read_wrapper(dir_path: str):
    ...
    all_json_paths = [dir_path / f for f in missing]
    if not all_json_paths:
        logging.info(f"No json files found in {dir_path}")
        return
