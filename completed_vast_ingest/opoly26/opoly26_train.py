"""
Open Polymers 2026 (OPoly26) — training set ingest script for ColabFit VAST database.
...
File notes
----------
Source: vast_ingest/opoly26/train/ (.aselmdb LMDB files)
...
loader.config_table = "ndb.colabfit.dev.co_opoly26_train"
loader.config_set_table = "ndb.colabfit.dev.cs_opoly26_train"
loader.dataset_table = "ndb.colabfit.dev.ds_opoly26_train"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_opoly26_train"

DATASET_ID = "DS_wfekwbgncjd3_0"
DATASET_NAME = "OPoly26-train"
DESCRIPTION = (
    "Training set of the Open Polymers 2026 (OPoly26) dataset. OPoly26 contains "
    "over 6.57 million density functional theory (DFT) calculations on cluster "
    "fragments of up to 360 atoms derived from polymeric systems, comprising over "
    "1.2 billion total atoms. The dataset encompasses variations in monomer "
