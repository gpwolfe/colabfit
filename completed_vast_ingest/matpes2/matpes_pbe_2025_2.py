"""
MatPES-PBE-2025.2 ingest script for ColabFit VAST database.
...
File notes
----------
Source: MatPES-PBE-2025.2-charges.json
433,189 structures sampled via the DIRECT method from 300 K NpT MD simulations
...
loader.config_table = "ndb.colabfit.dev.co_matpes_pbe_2"
loader.config_set_table = "ndb.colabfit.dev.cs_matpes_pbe_2"
loader.dataset_table = "ndb.colabfit.dev.ds_matpes_pbe_2"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_matpes_pbe_2"

DATASET_ID = "DS_9xi183g4pavv_1"
DATASET_NAME = "MatPES-PBE-2025.2"
DESCRIPTION = (
    ...
    "The v2025.2 PBE release contains 433,189 structures sampled via the DIRECT method "
    "from 300 K NpT molecular dynamics simulations seeded from Materials Project entries. "
    "Static DFT calculations were performed using VASP with the PBE functional and "
    "MatPESStaticSet convergence settings optimized for energy, force, and stress "
    ...
    "The previous version of this dataset (MatPES-PBE-2025.1) is available from ColabFit. "
    "There is a companion dataset calculated with the r2SCAN functional "
...
fp = Path("matpes2/MatPES-PBE-2025.2-charges.json")
gen = reader(fp)
