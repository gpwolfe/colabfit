...
loader.config_table = "ndb.colabfit.dev.co_qmcd2"
loader.config_set_table = "ndb.colabfit.dev.cs_qmcd2"
loader.dataset_table = "ndb.colabfit.dev.ds_qmcd2"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_qmcd2"


DATASET_FP = Path("data/DFT-D2_BLG_hBN_structures.hdf")
DATASET_ID = "DS_i9opcjvsb707_0"
DATASET_NAME = "Graphene-hBN_and_Graphene-Graphene_DFT_D2"
DESCRIPTION = "The DFT with D2 vdW corrections split of the Graphene-hBN_and_Graphene-Graphene dataset. This dataset family (see other Graphene-hBN_and_Graphene_Graphene datasets) contains data for Graphene-Graphene and Graphene-hexagonal boron nitride (hBN) ab initio calculations for structures with different interlayer distances and disregistries, calculated using DFT with D2 van der Waals corrections, DFT with D3 van der Waals corrections, and QMC methods."  # noqa: E501
...
property_map.set_metadata_field("method", "DFT-PBE+D2")
property_map.set_metadata_field("input", "not present")
