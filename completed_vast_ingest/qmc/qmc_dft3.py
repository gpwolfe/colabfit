...
DATASET_NAME = "Graphene-hBN_and_Graphene-Graphene_DFT_D3"
DESCRIPTION = "The DFT with D3 vdW corrections split of the Graphene-hBN_and_Graphene-Graphene dataset. This dataset family (see other Graphene-hBN_and_Graphene_Graphene datasets) contains data for Graphene-Graphene and Graphene-hexagonal boron nitride (hBN) ab initio calculations for structures with different interlayer distances and disregistries, calculated using DFT with D2 van der Waals corrections, DFT with D3 van der Waals corrections, and QMC methods."  # noqa: E501
