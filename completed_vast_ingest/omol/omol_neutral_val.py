...
loader.config_table = "ndb.colabfit.dev.co_omol_neutral_val"
loader.prop_object_table = "ndb.colabfit.dev.po_omol_neutral_val"
loader.config_set_table = "ndb.colabfit.dev.cs_omol_neutral_val"
loader.dataset_table = "ndb.colabfit.dev.ds_omol_neutral_val"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_omol_neutral_val"
...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/omol/neutral_val"  # noqa
)
DATASET_NAME = "OMol25_neutral_validation"
DATASET_ID = "DS_51sddg3b1bp1_0"
DESCRIPTION = "The neutral validation set from OMol25. From the dataset creator: OMol25 represents the largest high quality molecular DFT dataset spanning biomolecules, metal complexes, electrolytes, and community datasets. OMol25 was generated at the ω B97M-V/def2-TZVPD level of theory."  # noqa
DOI = None
