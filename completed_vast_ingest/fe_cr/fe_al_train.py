"""
FeAl-mMTP-Train ingest script for ColabFit VAST database.
...
File notes
----------
Source: datasets_for_magnetic_MTP-main/training_set.cfg
2012 configurations of 16-atom bcc Fe-Al supercells with collinear atomic
magnetic moments. Data in MLIP-2 .cfg format. PlusStress = stress × volume (eV).
DFT computed with ABINIT using constrained DFT (cDFT) and PAW PBE. Used to
train magnetic Moment Tensor Potentials (mMTPs) with 2 magnetic basis functions
for predicting formation energy, lattice parameters, and total magnetic moments
of bcc Fe-Al at varying Al concentrations.
"""
...
loader.config_table = "ndb.colabfit.dev.co_fe_al_train"
loader.config_set_table = "ndb.colabfit.dev.cs_fe_al_train"
loader.dataset_table = "ndb.colabfit.dev.ds_fe_al_train"
loader.co_cs_map_table = "ndb.colabfit.dev.cs_co_map_fe_al_train"

DATASET_ID = "DS_ju6xp036xxv9_0"
DATASET_NAME = "FeAl-mMTP-Training"
DESCRIPTION = (
    "Training set for magnetic Moment Tensor Potentials (mMTPs) for the bcc "
    "Fe-Al system. Contains 2012 configurations of 16-atom Fe-Al supercells "
    "with collinear atomic magnetic moments. Configurations were generated "
    ...
    "fitted mMTPs (with 2 magnetic basis functions) predict formation energy, "
    "lattice parameters, and total magnetic moments of bcc Fe-Al at 0 K "
    "across varying Al concentrations. Note: "
...
DATA_PATH = (
    Path().parent / "data" / "datasets_for_magnetic_MTP-main" / "training_set.cfg"
)
