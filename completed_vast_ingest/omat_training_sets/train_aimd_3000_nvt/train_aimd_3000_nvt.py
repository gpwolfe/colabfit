...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/omat/omat_train_pickles/aimd-from-PBE-3000-nvt/"  # noqa
)
DATASET_NAME = "OMat24_train_aimd_from_PBE_3000_nvt"
DATASET_ID = "DS_fi9ozets1s5f_0"
