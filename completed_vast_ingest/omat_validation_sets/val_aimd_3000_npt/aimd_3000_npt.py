...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/omat/omat_val_pickles/omat24_val_aimd-from-PBE-3000-npt/"  # noqa
)
DATASET_NAME = "OMat24_validation_aimd-from-PBE-3000-npt"
DATASET_ID = "DS_krd83tt1g6wd_0"
