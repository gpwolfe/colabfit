...
DATASET_FP = Path(
    "/scratch/gw2338/vast/data-lake-main/spark/scripts/gw_scripts/omat/omat_val_pickles/omat24_val_rattled-1000-subsampled/"  # noqa
)
DATASET_NAME = "OMat24_validation_rattled_1000_subsampled"
DATASET_ID = "DS_c4s38mdirjf7_0"
DOI = None
