...
GLOB = "ocp_all.json"
DS_NAME = "JARVIS_Open_Catalyst_All"
DS_DESC = (
    "The JARVIS_Open_Catalyst_All dataset is part of the joint automated "
    "repository for various integrated simulations (JARVIS) DFT database. "
    "This subset contains configurations from the Open Catalyst Project (OCP) "
    "460328 training, rest validation and test dataset. "
    "JARVIS is a set of "
...
def main(argv):
    ...
    parser.add_argument(
        ...
        "--port",
        type=int,
        help="Port to use for MongoDB client",
        default=27017,
    )
