...
Move file to a new parent directory before running script.
mkdir <project_dir>/data/tsff_plos_2022
mv pone.0264960.s001.log <project_dir>/data/tsff_plos_2022/
...
DATASET_FP = Path("/Users/piper/Code/colabfit/data/tsff_plos_2022")
