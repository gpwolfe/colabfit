...
unzip NNIP-FeH-main.zip "**/*.tar*" -d <project_dir>/data
** THE FOLLOWING LINE IS REQUIRED TO PROPERLY CONSTRUCT DATABASE **
** A NORMAL TAR COMMAND WILL RESULT IN THREE INCOMPLETE DATABASES **
cat NNIP-FeH-main/DATABASE/database.tar.gz* | tar -zxv
...
def main(argv):
    ...
    client.insert_dataset(
        ...
        all_do_ids,
        name=DATASET,
        authors="F. Meng, J. Du, S. Shinzato, H. Mori, P. Yu, K. Matsubara, N. Ishikawa, S. Ogata",
        links=[
            "https://github.com/mengfsou/NNIP-FeH",
